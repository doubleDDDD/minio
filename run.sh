...
nohup go run /root/double_D/minio/main.go server \
                http://172.20.0.3/root/res/miniodir \
                http://172.20.0.4/root/res/miniodir \
                http://172.20.0.5/root/res/miniodir \
                http://172.20.0.6/root/res/miniodir \
                --console-address ":9001" > /root/double_D/minio/userminio.log 2>&1 &
